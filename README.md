...
- SUN RGB-D pretrained model: [https://drive.google.com/file/d/1-ZujySGPiLxzyu8OWsUkzxXsLHPisVMq/view?usp=sharing](https://drive.google.com/file/d/1-ZujySGPiLxzyu8OWsUkzxXsLHPisVMq/view?usp=sharing). Hugging Face mirror is pending because the source did not expose a retrievable public file URL during this cleanup.
- ScanNet pretrained models: [https://drive.google.com/drive/folders/1Af5mRVwwI370txOREXkooea8nK_SwzGk?usp=sharing](https://drive.google.com/drive/folders/1Af5mRVwwI370txOREXkooea8nK_SwzGk?usp=sharing). Hugging Face mirror is pending because the source did not expose a retrievable public file URL during this cleanup.
- Scan2CAD/ScanNet processed data and annotations: Google Drive links in README. license-restricted ScanNet/Scan2CAD-derived assets; flagged for approval, not uploaded
- Processed SceneNN data: [https://mega.nz/folder/n7hzDQxb#mV8t4d7psPYN5bSkkxHuYw](https://mega.nz/folder/n7hzDQxb#mV8t4d7psPYN5bSkkxHuYw). processed third-party dataset; Mega download unsupported here and redistribution needs approval
